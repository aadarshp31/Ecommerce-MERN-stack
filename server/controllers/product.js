...
exports.searchProducts = async (req, res) => {
	try {
		let { name, minPrice, maxPrice, limit, skip, sortBy, ascDesc, minRating, maxRating } = req.query;

		if (name === undefined && minPrice === undefined && maxPrice === undefined && minRating === undefined && maxRating === undefined) {
		...
		if (minRating) queryConfig.rating = { ...queryConfig.rating, $gte: parseInt(minRating) };
		if (maxRating) queryConfig.rating = { ...queryConfig.rating, $lte: parseInt(maxRating) };
